        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={{ marginTop: 10 }}>
                    ...
                    <View>
                        <Text style={{ fontSize: 25, textAlign: 'center' }}>Dương Lịch</Text>
                    </View>
                    <ScrollView>
                        <View style={{ marginTop: 10 }}>
                            <FlatList
                                ...
                                renderItem={({ item }) => {
                                    return (
                                        <View style={{ flex: 1, marginTop: 5, backgroundColor: '#FFFFFF' }}>
                                            <View >
                                                <Text style={{ fontSize: 20, margin: 5, fontWeight: 'bold' }}>{item.day + '/' + item.month}</Text>
                                            </View>
                                            <View >
                                                <Text style={{ fontSize: 20, margin: 5 }}>{item.event}</Text>
                                            </View>
                                        </View>
                                    )
                                }
